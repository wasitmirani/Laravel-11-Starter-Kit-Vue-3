    ...
    (function () {
        ...
        var s,
            ...
            n =
                (window.templateCustomizer &&
                    ...
                    (n = n.querySelector("i")),
                    "light" === i
                        ? (n.classList.add("ri-sun-line"), new bootstrap.Tooltip(n, { title: "Light Mode", fallbackPlacements: ["bottom"] }))
                        : "dark" === i
                        ? (n.classList.add("ri-moon-clear-line"), new bootstrap.Tooltip(n, { title: "Dark Mode", fallbackPlacements: ["bottom"] }))
                        : (n.classList.add("ri-computer-line"), new bootstrap.Tooltip(n, { title: "System Mode", fallbackPlacements: ["bottom"] }))),
        ...
        function d(e) {
            "show.bs.collapse" == e.type || "show.bs.collapse" == e.type
                ? (e.target.closest(".accordion-item").classList.add("active"), e.target.closest(".accordion-item").previousElementSibling?.classList.add("previous-active"))
                : (e.target.closest(".accordion-item").classList.remove("active"), e.target.closest(".accordion-item").previousElementSibling?.classList.remove("previous-active"));
        }
